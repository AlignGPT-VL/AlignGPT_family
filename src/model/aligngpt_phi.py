...
class AlignGPTPhiConfig(PhiConfig):
    model_type = 'aligngpt_phi'
    n_indicators = 8
    use_s2 = False
    s2_scales = '336'
    

class AlignGPTPhiForCausalLM(PhiForCausalLM):
    config_class = AlignGPTPhiConfig
...
AutoConfig.register("aligngpt_phi", AlignGPTPhiConfig)
AutoModelForCausalLM.register(AlignGPTPhiConfig, AlignGPTPhiForCausalLM)
