...
class AlignGPTQwen2Config(Qwen2Config):
    model_type = 'aligngpt_qwen2'
    n_indicators = 8
    use_s2 = False
    s2_scales = '336'
    

class AlignGPTQwen2ForCausalLM(Qwen2ForCausalLM):
    config_class = AlignGPTQwen2Config
...
AutoConfig.register("aligngpt_qwen2", AlignGPTQwen2Config)
AutoModelForCausalLM.register(AlignGPTQwen2Config, AlignGPTQwen2ForCausalLM)
