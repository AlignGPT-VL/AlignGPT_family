...
from transformers import AutoConfig, AutoModelForCausalLM, GemmaModel, GemmaConfig, GemmaForCausalLM
...
class AlignGPTGemmaConfig(GemmaConfig):
    model_type = 'aligngpt_gemma'
    n_indicators = 8
    use_s2 = False
    s2_scales = '336'
    

class AlignGPTGemmaForCausalLM(GemmaForCausalLM):
    config_class = AlignGPTGemmaConfig
...
AutoConfig.register("aligngpt_gemma", AlignGPTGemmaConfig)
AutoModelForCausalLM.register(AlignGPTGemmaConfig, AlignGPTGemmaForCausalLM)
