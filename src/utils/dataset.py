...
def preprocess(
    ...
    #     print('here process llama3')
    #     return preprocess_llama_3(sources, tokenizer, has_image=has_image)
    
    elif conversation_lib.default_conversation.version == 'llama_3':
        return preprocess_llama3_v1(sources, tokenizer, has_image=has_image)
    elif conversation_lib.default_conversation.version == 'llama_v2':
        return preprocess_llama_2(sources, tokenizer, has_image=has_image)
    elif conversation_lib.default_conversation.version == "gemma":
        return preprocess_gemma(sources, tokenizer, has_image=has_image)
    elif conversation_lib.default_conversation.version == "phi2":
        return preprocess_v1(sources, tokenizer, has_image=has_image)
    elif conversation_lib.default_conversation.version == "phi_1_5":
        return preprocess_v1(sources, tokenizer, has_image=has_image)
