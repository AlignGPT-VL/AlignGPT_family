...
python -m src.eval.model_vqa_loader \
    ...
    --answers-file /workspace/hal/LLaVA/playground/data/eval/MME/answers/aligngpt-7b_llama3.jsonl \
    --temperature 0 \
    --conv-mode llama_3

cd /workspace/hal/LLaVA/playground/data/eval/MME

python convert_answer_to_mme.py --experiment aligngpt-7b_llama3_output

cd eval_tool

python calculation.py --results_dir /workspace/hal/LLaVA/playground/data/eval/MME/MME_Benchmark_release_version/eval_tool/answers/aligngpt-7b_llama3_output
