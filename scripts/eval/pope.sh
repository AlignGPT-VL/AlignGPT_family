...
python -m src.eval.model_vqa_loader \
    ...
    --answers-file /workspace/hal/LLaVA/playground/data/eval/pope/answers/aligngpt-7b_s2_1008.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1
...
python src/eval/eval_pope.py \
    ...
    --question-file /workspace/hal/LLaVA/playground/data/eval/pope/llava_pope_test.jsonl \
    --result-file /workspace/hal/LLaVA/playground/data/eval/pope/answers/aligngpt-7b_s2_1008.jsonl
