...
python -m src.eval.model_vqa_loader \
    ...
    --answers-file /workspace/hal/LLaVA/playground/data/eval/textvqa/answers/aligngpt-7b_llama3.jsonl \
    --temperature 0 \
    --conv-mode llama_3

python -m src.eval.eval_textvqa \
    --annotation-file /workspace/hal/LLaVA/playground/data/eval/textvqa/TextVQA_0.5.1_val.json \
    --result-file /workspace/hal/LLaVA/playground/data/eval/textvqa/answers/aligngpt-7b_llama3.jsonl
